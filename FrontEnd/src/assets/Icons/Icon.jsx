// SVG Icon Components – reusable for the entire application.
// Each component accepts an optional `color` prop (default "currentColor") for custom styling.
...
export const FlowchartIcon = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#4FC3F7" strokeWidth="2">
        <rect x="3" y="3" width="6" height="6" />
        <polygon points="17,3 21,6 17,9 13,6" />
...
export const FAQIcon = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#4FC3F7" strokeWidth="2" strokeLinecap="round">
        <circle cx="12" cy="12" r="10" />
